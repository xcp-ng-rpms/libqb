...
Source0:        https://code.citrite.net/rest/archive/latest/projects/XSU/repos/libqb/archive?at=refs%2Ftags%2Fv%{version}&format=tar.gz&prefix=%{name}-%{version}#/%{name}-%{version}.tar.gz
...
Provides:       xenserver-%{name}-devel = %{version}-%{release}
...
%changelog
* Thu Mar 15 2018 Edwin Török <edvin.torok@citrix.com> - 1.0.1-6
- Use versioned xenserver-corosync Provides
- CP-27385: fix version in libqb.pc
